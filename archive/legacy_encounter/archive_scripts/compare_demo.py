# ============================================================================
# 已归档的演示脚本 — 无法直接运行（ARCHIVED DEMO HARNESS, DOES NOT RUN）。
# 依赖已归档/移动的模块（如 scripts.realtime_demo），路径已失效。
# 仅作 legacy_encounter 原型的历史参考，不是当前证据。
# 当前 1.0 证据链见 scripts/ 下脚本与 docs/1.0_EVIDENCE.md。
# ============================================================================
"""
